...
class RequestQueue(object):
    ...
    def __init__(self, max_outstanding=50, timeout=15):
        ...
        """
        self.queue = []  # [(RequestManager, callable, QueuePriorityEnum, time, [performed])]
    ...
    def enqueue(self, request_manager, callback, priority=QueuePriorityEnum.CRITICAL):
        ...
        :param request_manager: the RequestManager wishing to perform a request.
...
class RequestManager(QNetworkAccessManager):
    """
    This class is responsible for all the requests made to the REST API.
    """
    window = None
    ...
    def on_finished(self, reply, capture_errors):
        ...
        try:
            ...
            if 'error' in json_result and capture_errors:
                self.show_error(RequestManager.get_message_from_error(json_result))
            else:
    ...
    def show_error(self, error_text):
        ...
        error_dialog = ConfirmationDialog(RequestManager.window, "Request error",
